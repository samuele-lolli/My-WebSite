        ...
        <section id="skills" className="py-16 px-4 sm:px-6 bg-[#1a1a1a] bg-opacity-90 text-center text-[#cccccc]">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                {[
                    ...
                    <div
                        key={skill.name}
                        className="relative bg-gradient-to-br from-[#1a1a1a] to-[#0d0d0d] border border-[#52b788] p-2 rounded-lg hover:scale-105 hover:border-[#cccccc] transition duration-300 shadow-md flex flex-col items-center"
                    >
