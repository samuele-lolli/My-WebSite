export default function Skills() {
    return (
        <section id="skills" className="py-20 px-6 bg-[#1a1a1a] bg-opacity-90 text-center text-[#cccccc]">
            <h2 className="text-4xl font-bold mb-6 text-[#52b788] drop-shadow-md">Skills</h2>
